...
def write_log(casename):
 ...
 #  Seq_Navio = data['Seq_Navio'].tolist()
  ...
  #  model = restricao_P10(model,omega,N,H,W,T)
    ...
    model = restricao_I6(model,phi,R,C,T,P,N,startVar,startVal) 
...
if __name__ == "__main__":
    ...
    lista_aleatoria = [3, 4, 7, 10, 11, 12]

    for n in range(1, 12):
        if n in lista_aleatoria:
            name_instance = 'SolucaoInicial_Aleatoria_Instancia_' + str(n)
            print(name_instance)
            _ = write_log(name_instance)

        else:
            name_instance = 'SolucaoInicial_Instancia_' + str(n)
            print(name_instance)
            _ = write_log(name_instance)

    for t in range(1, 10):
         if t == 7:
             name_instance = 'SolucaoInicial_Aleatoria_Instancia_' + str(t) + '_1'
             print(name_instance)
             _ = write_log(name_instance)
    
         else:
             name_instance = 'SolucaoInicial_Instancia_' + str(t) + '_1'
             print(name_instance)
             _ = write_log(name_instance)