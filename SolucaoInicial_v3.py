...
def SolucaoInicial(casename):
 ...
 #   print('Tamanho startVal = ', restricoes2)
   ...
   # model.parameters.timelimit.set(432000)  # limite de tempo em segundos (5 dias)
    ...
    Navio=np.array(Navio)
    Pt=np.array(Pt)
    Arquivos_Salvos1='Navio_Arquivos_Salvos_'+casename
    Arquivos_Salvos2='Pt_Arquivos_Salvos_'+casename
    np.save(Arquivos_Salvos1,Navio)
    np.save(Arquivos_Salvos2,Pt)
